      ...
      <div className="max-w-2xl mx-auto px-5 pt-24 pb-20">
        ...
        <div className="space-y-8 text-white/65 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>Atur Pintar adalah layanan digital langganan (SaaS) yang dikelola oleh <strong className="text-white">PT Rideff Vreka Tech</strong>. Karena layanan langsung aktif setelah pembayaran, pengembalian dana dibatasi pada kondisi-kondisi tertentu.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1.5 text-white/55">
              ...
              <li><strong className="text-white/80">Permintaan dalam 7 hari pertama</strong> setelah pembayaran paket bulanan/tahunan, dengan syarat pengguna belum menggunakan fitur Premium secara material.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>Setelah refund diproses, akses Premium akan dinonaktifkan dan akun otomatis dikembalikan ke paket <strong className="text-white">Free</strong>. Data transaksi keuangan kamu tetap aman dan tersimpan sesuai kebijakan privasi kami.</p>
          </section>
