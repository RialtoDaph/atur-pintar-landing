      ...
      <div className="max-w-2xl mx-auto px-5 pt-24 pb-20">
        ...
        <div className="space-y-8 text-white/65 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-2"><strong className="text-white">Atur Pintar</strong> adalah layanan aplikasi manajemen keuangan pribadi berbasis kecerdasan buatan ("Layanan"), yang dikelola oleh <strong className="text-white">PT Rideff Vreka Tech</strong>.</p>
            <p>Dengan mendaftar atau menggunakan Layanan, kamu ("Pengguna") menyatakan telah membaca, memahami, dan menyetujui Syarat & Ketentuan ini serta <Link to="/PrivacyPolicy" className="text-[#FF6A00]">Kebijakan Privasi</Link>.</p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3 text-white/55">Harga langganan Premium ditampilkan secara transparan di halaman Berlangganan dan dapat berubah dengan pemberitahuan minimal 30 hari sebelumnya melalui email atau notifikasi dalam aplikasi.</p>
            ...
            <p className="mb-3 text-white/55">Kebijakan refund mengatur kondisi-kondisi tertentu di mana pengembalian dana dapat diajukan (mis. pembayaran ganda, akses Premium tidak aktif, gangguan teknis tertentu).</p>

            <p className="mb-2 font-semibold text-white/80">4.6 Pembatalan Langganan</p>
            <p className="mb-3 text-white/55">Karena berlangganan bersifat satu kali bayar (tidak auto-renewal), pembatalan dilakukan dengan tidak memperpanjang. Selama periode aktif, akses Premium tetap tersedia sampai akhir periode yang sudah dibayar.</p>
          </section>
          ...
          <section>
            ...
            <div className="bg-[#FF6A00]/8 border border-[#FF6A00]/20 rounded-xl p-4">
              <p className="text-white/75 leading-relaxed">Atur Pintar, termasuk fitur <strong className="text-white">Nana AI</strong>, adalah alat bantu manajemen keuangan yang bersifat informatif dan edukatif. Informasi yang diberikan tidak boleh dianggap sebagai nasihat keuangan profesional.</p>
          ...
          <section>
            ...
            <p>Kami berupaya menyediakan layanan dengan uptime setinggi mungkin (target 99,5%). Namun kami tidak menjamin ketersediaan tanpa gangguan. Pemeliharaan terjadwal akan diberitahukan minimal 24 jam sebelumnya.</p>
          </section>

          <section>
            <h2 className="text-white font-bold text-base mb-3">8. Kekayaan Intelektual</h2>
            <p>Seluruh konten, desain, logo, merek, dan kode sumber Atur Pintar adalah milik Pengelola dan dilindungi oleh hukum kekayaan intelektual Indonesia. Pengguna tidak diberikan hak atas kepemilikan kecuali diberikan lisensi terbatas untuk menggunakan layanan.</p>
          </section>

          <section>
            <h2 className="text-white font-bold text-base mb-3">9. Perubahan Syarat Layanan</h2>
            <p>Pengelola berhak mengubah Syarat & Ketentuan ini kapan saja. Perubahan material akan diberitahukan melalui email atau notifikasi dalam aplikasi minimal 14 hari sebelum berlaku.</p>
          </section>

          <section>
            <h2 className="text-white font-bold text-base mb-3">10. Penghentian Layanan</h2>
            <p>Kamu dapat menghentikan penggunaan layanan kapan saja dengan menghapus akun melalui halaman Profil. Pengelola berhak menghentikan atau menangguhkan akun yang melanggar Syarat & Ketentuan tanpa pemberitahuan apabila terdapat pelanggaran berat.</p>
          </section>

          <section>
            <h2 className="text-white font-bold text-base mb-3">11. Hukum yang Berlaku dan Penyelesaian Sengketa</h2>
            <p>Syarat & Ketentuan ini tunduk pada <strong className="text-white">Hukum Republik Indonesia</strong>. Sengketa diselesaikan melalui musyawarah mufakat, mediasi, atau jalur hukum sesuai ketentuan yang berlaku.</p>
          ...
          <section>
            ...
            <p className="mt-2 text-white/55">Untuk pertanyaan, keluhan, atau laporan, silakan hubungi kami melalui email: <span className="text-[#FF6A00] font-medium">admin@aturpintar.id</span>.</p>
          </section>
        </div>
      </div>
