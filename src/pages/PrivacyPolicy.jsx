      ...
      <div className="max-w-2xl mx-auto px-5 pt-24 pb-20">
        ...
        <div className="space-y-8 text-white/65 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-1 text-white/50 text-xs">Data yang kami kumpulkan meliputi: email, nama, data transaksi keuangan, dan profil pengguna — digunakan semata-mata untuk layanan manajemen[...]</p>
          </section>
          ...
          <section>
            ...
            <p>Data disimpan di server yang dikelola oleh <strong className="text-white">Base44</strong> dengan enkripsi standar industri (TLS/SSL). Data keuangan kamu hanya dapat diakses oleh aku[...]</p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-white/55">
              <li><strong className="text-white/80">Xendit (PT Xendit Investasi Indonesia)</strong> — Pemrosesan pembayaran langganan. Data kartu kredit/rekening diproses langsung oleh Xendit da[...]</li>
              <li><strong className="text-white/80">OpenAI / Anthropic</strong> — Layanan AI untuk fitur Nana AI. Pertanyaan yang kamu ajukan dapat dikirim ke API mereka untuk diproses, tanpa me[...]</li>
          ...
          <section>
            ...
            <p>Atur Pintar menggunakan cookie sesi yang diperlukan untuk menjaga status login kamu. Kami tidak menggunakan cookie pelacakan iklan pihak ketiga. Kamu dapat menonaktifkan cookie mel[...]</p>
          </section>

          <section>
            <h2 className="text-white font-bold text-base mb-3">9. Transfer Data Internasional</h2>
            <p>Beberapa layanan pihak ketiga yang kami gunakan (seperti OpenAI/Anthropic) mungkin memproses data di luar Indonesia. Kami memastikan transfer data tersebut dilindungi oleh perjanji[...]</p>
          </section>

          <section>
            <h2 className="text-white font-bold text-base mb-3">10. Perubahan Kebijakan Privasi</h2>
            <p>Kami dapat memperbarui kebijakan ini sesuai perubahan layanan atau peraturan yang berlaku. Perubahan signifikan akan diberitahukan melalui email atau notifikasi dalam aplikasi mini[...]</p>
          </section>
