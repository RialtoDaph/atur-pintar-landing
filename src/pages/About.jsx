        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              Atur Pintar dikembangkan oleh <strong className="text-white">PT Rideff Vreka Tech</strong>, perusahaan teknologi Indonesia yang berkomitmen membantu masyarakat mengelola keuangan pribadinya melalui alat digital yang sederhana dan aman.
            </p>
          </div>
