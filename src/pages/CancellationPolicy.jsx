      ...
      <div className="max-w-2xl mx-auto px-5 pt-24 pb-20">
        ...
        <div className="space-y-8 text-white/65 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>Kamu dapat membatalkan langganan Premium <strong className="text-white">kapan saja</strong> tanpa biaya pembatalan. Setelah dibatalkan, akses Premium tetap aktif sampai akhir periode yang sudah dibayar.</p>
          </section>

          <section>
            <h2 className="text-white font-bold text-base mb-3">2. Cara Membatalkan Langganan</h2>
            <p className="mb-3">Saat ini Atur Pintar menggunakan model pembayaran <strong className="text-white">satu kali per periode</strong> (bukan auto-debit otomatis). Untuk berhenti berlangganan, kamu dapat memilih salah satu opsi berikut:</p>
            ...
            <p className="mt-3">Bila kamu tidak menemukan opsinya atau butuh bantuan, kirim email ke <span className="text-[#FF6A00] font-medium">admin@aturpintar.id</span> dengan subjek "Batalkan Langganan".</p>
          </section>
          ...
          <section>
            ...
            <p>Pembatalan langganan di tengah periode <strong className="text-white">tidak otomatis mengembalikan</strong> sisa biaya yang sudah dibayar. Akses Premium kamu berjalan sampai akhir periode yang sudah dibayar, namun kamu dapat mengajukan permintaan refund jika memenuhi syarat sesuai Kebijakan Refund.</p>
          </section>

          <section>
            <h2 className="text-white font-bold text-base mb-3">6. Penghapusan Akun</h2>
            <p>Pembatalan langganan <strong className="text-white">tidak sama</strong> dengan penghapusan akun. Akun kamu tetap aktif di paket Free. Jika kamu ingin menghapus akun sepenuhnya beserta semua data, silakan hubungi admin melalui email: <span className="text-[#FF6A00]">admin@aturpintar.id</span>.</p>
          </section>
