...
const FAQS = [
  ...
  { q: "Apakah Atur Pintar gratis?", a: "Ya, ada versi gratis selamanya. Kamu bisa catat transaksi, pakai Nana AI, dan akses fitur gamifikasi tanpa bayar apapun." },
  ...
  { q: "Bedanya Free dan Plus?", a: "Free: tracker lengkap, Nana AI, dan fitur dasar. Plus: Nana AI unlimited, analytics advanced, shared wallet unlimited, dan semua fitur premium lainnya." }
];
