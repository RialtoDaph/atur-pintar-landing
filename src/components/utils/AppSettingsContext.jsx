...
const TRANSLATIONS = {
  id: {
    ...
    manage_income_expenses: 'Kelola pengeluaran dan pemasukan rutin',
  ...
  en: {
    ...
    manage_income_expenses: 'Manage recurring expenses and income',
  ...
  de: {
    ...
    manage_income_expenses: 'Verwalte regelmäßige Ausgaben und Einnahmen',
