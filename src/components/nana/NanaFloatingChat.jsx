  ...
  return (
    <>
      ...
      <img
        ...
        alt="Nana AI"
        onClick={openChat} className="opacity-100 rounded-[40px] fixed bottom-24 right-4 sm:bottom-6 sm:right-6 z-50 w-14 h-14 hover:opacity-90 transition-all active:scale-95 nana-float cursor-pointer" />
