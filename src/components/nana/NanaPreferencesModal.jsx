  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-end sm:items-center sm:justify-center bg-black/50" onClick={onClose}>
      <div
        role="dialog"
        aria-modal="true"
        className="w-full sm:max-w-lg bg-[#F2F4F7] dark:bg-[#0F1114] rounded-t-2xl sm:rounded-2xl shadow-xl max-h-[85vh] flex flex-col animate-slide-up-sheet overscroll-contain"
