...
const QUIZ_QUESTIONS = [
  {
    ...
    options: [
      { key: "A", emoji: "🎉", text: "Bayarin temen yang minta Traktiran" },
      { key: "B", emoji: "📱", text: "Langsung cekout Shopee yang udah lama dikeranjang" },
  ...
  },
  {
    ...
    options: [
      ...
      { key: "B", emoji: "😤", text: '"Masih ada sih, tapi entah cukup atau engga"' },
  ...
  },
  {
    ...
    options: [
      ...
      { key: "B", emoji: "😬", text: "Nabung kalau sisa, nyatanya gak pernah sisa" },
