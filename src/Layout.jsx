        ...
        {mobileMainNav.map((item) => {
           ...
           return (
             <button
              ...
              className={`flex-1 flex flex-col items-center py-2 gap-0.5 text-[10px] font-medium transition-colors tap-highlight-fix rounded-full border-none cursor-pointer mx-1 ${
              active ? "text-[#FF6A00] bg-white/10" : "text-[#888] bg-transparent"}`}
            >
