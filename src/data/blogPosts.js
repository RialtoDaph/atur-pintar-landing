export const BLOG_POSTS = [
  {
    slug: "5-cara-nabung-anak-muda",
    title: "5 Cara Nabung untuk Anak Muda yang Gampang Dimulai",
    excerpt: "Nabung bukan soal banyak duit, tapi soal kebiasaan. Ini 5 cara nabung yang realistis buat anak muda yang baru mulai.",
...
## 2. Pisahkan tabungan dari rekening harian

Ini aturan emas: jangan simpan tabungan di rekening yang kamu pakai buat gofood, shopee, dan bayar tagihan. Otak kamu akan ngeliat saldo dan mikir "wah masih banyak, aman beli ini". Pisahkan ke rekening lain atau e-wallet terpisah yang nggak kamu buka tiap hari.

## 3. Otomatisasi dengan auto-debit

Kekuatan terbesar dalam nabung adalah: lupa kalau lagi nabung. Set auto-debit dari gaji ke rekening tabungan di tanggal gajian. Duit masuk tabungan duluan sebelum sempat dipakai. Prinsipnya: **bayar diri sendiri dulu**.

## 4. Pakai metode 50/30/20

Bagi gaji jadi tiga: 50% kebutuhan, 30% keinginan, 20% tabungan & investasi. Kalau 20% terasa berat, mulai 10% dulu. Yang penting ada porsi nabung yang konsisten setiap bulan.

## 5. Bikin goal yang spesifik

"nabung aja" terlalu abstrak. Bikin goal: "nabung Rp 3 juta buat liburan akhir tahun" atau "nabung Rp 5 juta buat dana darurat". Goal yang spesifik bikin kamu lebih motivated karena ada gambaran jelas kenapa kamu nabung.
...
## 1. Catat transaksi dulu sebelum tanya

Nana paling powerful kalau dia punya data. Sebelum nanya saran, pastikan kamu udah catat transaksi minimal 1-2 minggu. Nana akan analisis pola pengeluaran kamu: kategori apa yang paling boros, hari apa kamu paling sering belanja, dan apakah ada subscription yang kamu lupa.

## 2. Tanya spesifik, bukan general

❌ "Gimana cara nabung?"
✅ "Aku boros 2 juta buat makan bulan ini, gimana cara ngurangin?"

Makin spesifik pertanyaan kamu, makin tajam jawaban Nana. Dia bisa lihat data kamu dan kasih saran yang langsung applicable.
...
Setiap akhir minggu, tanya Nana: "Ringkasan pengeluaran minggu ini gimana?" Dia bakal kasih breakdown kategori, perbandingan vs minggu lalu, dan saran buat minggu depan.
...
## Nana itu bestie, bukan guru

Nana bukan designed untuk nyalahin atau bikin kamu guilty soal pengeluaran. Dia ada buat bantu kamu ngerti pola keuangan sendiri, kasih saran yang actionable, dan bikin keputusan finansial lebih sadar.

Kalau kamu belum pernah coba, buka Atur Pintar dan chat Nana sekarang. Mulai dengan pertanyaan simpel: "Halo Nana, gimana kondisi keuanganku bulan ini?" dan lihat apa yang dia kasih.`
  },
  {
    slug: "budgeting-50-30-20",
    title: "Budgeting 50/30/20: Cara Bagi Gaji Biar Gak Boncos",
    excerpt: "Aturan 50/30/20 adalah cara paling simpel untuk bagi gaji. Gak perlu spreadsheet rumit, cukup pahami 3 porsi ini.",
    category: "Tips Keuangan",
    date: "2026-06-18",
...
Diperkenalkan oleh Senator AS Elizabeth Warren, aturan ini membagi pendapatan after-tax jadi:
...
**Contoh:** Gaji Rp 5 juta → Rp 1 juta untuk tabungan.
...
Kalau kamu butuh bantuan tracking, Atur Pintar punya fitur budget per kategori yang otomatis ngitung sisa budget kamu real-time. Set budget makanan Rp 1 juta, dan setiap kamu catat transaksi makanan, sisa budget langsung update. Gampang banget.`
  ...
  {
    slug: "fitur-shared-wallet",
    title: "Fitur Shared Wallet: Nabung Bareng Teman & Pasangan Jadi Lebih Seru",
    excerpt: "Shared Wallet memungkinkan kamu nabung bareng pasangan atau teman dalam satu dompet bersama. Ini cara kerjanya.",
...
Itulah kenapa kita bikin **Shared Wallet**.
...
### 1. Pasangan menabung bareng

Buat dompet "Dana Pernikahan" atau "Dana Rumah". Suami dan istri bisa catat kontribusi masing-masing. Transparan, nggak ada drama "kamu kurang nabung".
...
1. Buka Atur Pintar → menu **Shared Wallet**
2. Klik **Buat Dompet Baru**
3. Isi nama dompet dan undang anggota via email
4. Mulai catat transaksi bersama

---

Shared Wallet sudah tersedia untuk semua user Atur Pintar. Kalau kamu belum punya akun, daftar gratis sekarang dan coba fitur ini bareng teman atau pasangan kamu.`
  },
  {
    slug: "investasi-pemula-5-kesalahan",
    title: "Investasi Pemula: 5 Kesalahan yang Sering Bikin Rugi",
    excerpt: "Investasi itu alat keuangan yang bagus, tapi banyak pemula langsung rugi karena kesalahan ini. Hindari dari awal.",
    category: "Tips Keuangan",
    date: "2026-06-03",
...
## 3. Nggak paham apa yang dibeli

Beli reksa dana tanpa ngerti strateginya. Beli saham tanpa baca laporan keuangan. Beli crypto tanpa ngerti teknologinya. Ini spekulasi, bukan investasi.

**Aturan:** Sebelum beli aset apapun, pastikan kamu bisa explain dalam 1 menit kenapa kamu beli itu. Kalau nggak bisa, jangan beli.

## 4. Masuk semua duit sekaligus (lump sum)
